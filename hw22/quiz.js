...
const showResult = () => {
  ...
  // <h3 class="correct">Correct Answers: ${correctCount}</h3>
  // <h3 class="wrong">Wrong Answers: ${wrongCount}</h3>
  // <h2 class="score">Score: ${(correctCount - wrongCount) * 10}</h2>
  // <button class="play">Play again</button>`
  // сделал вот так , но в итоге кнопка не работала Play again , не вешался onclick я так понял :(
